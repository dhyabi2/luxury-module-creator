...
const Accessories = () => {
  const [activeFilters, setActiveFilters] = useState<Record<string, any>>({
    ...
    category: 'accessories' // Set the category filter to accessories
  });
  ...
  const handleFilterChange = useCallback((filters: Record<string, any>) => {
    ...
    setActiveFilters({
      ...filters,
      category: 'accessories' // Always keep the accessories category filter
    });
  }, []);
    ...
    <MainLayout>
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-12 overflow-hidden rounded-lg relative">
          <div className="h-[200px] sm:h-[250px] bg-gray-700 relative flex items-center">
        ...
        <div className="text-xs sm:text-sm text-gray-600 mb-6 sm:mb-8 tracking-wider overflow-x-auto whitespace-nowrap pb-2">
          <span className="hover:text-black cursor-pointer transition-colors">HOME</span> / <span className="font-medium text-gray-900">ACCESSORIES</span>
        </div>
