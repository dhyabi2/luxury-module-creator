...
const Jewellery = () => {
  const [activeFilters, setActiveFilters] = useState<Record<string, any>>({
    ...
    category: 'jewellery' // Set the category filter to jewellery
  });
  ...
  const handleFilterChange = useCallback((filters: Record<string, any>) => {
    ...
    setActiveFilters({
      ...filters,
      category: 'jewellery' // Always keep the jewellery category filter
    });
  }, []);
    ...
    <MainLayout>
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-12 overflow-hidden rounded-lg relative">
          <div className="h-[200px] sm:h-[250px] bg-gray-800 relative flex items-center">
            <div className="container mx-auto px-4 md:px-8 z-10">
              <div className="max-w-xl">
                ...
                <p className="text-white/90 mb-6 text-sm sm:text-base leading-relaxed">
                  Explore our curated collection of exquisite jewellery pieces.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-xs sm:text-sm text-gray-600 mb-6 sm:mb-8 tracking-wider overflow-x-auto whitespace-nowrap pb-2">
          <span className="hover:text-black cursor-pointer transition-colors">HOME</span> / <span className="font-medium text-gray-900">JEWELLERY</span>
        </div>
