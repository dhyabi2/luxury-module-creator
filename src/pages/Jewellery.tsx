...
const Jewellery = () => {
  ...
  const handleFilterChange = (filters: Record<string, any>) => {
    console.log("Jewellery page filters changed:", filters);
  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">MKWatches Jewellery Collection</h1>
